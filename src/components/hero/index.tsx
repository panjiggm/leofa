    ...
    <section className='bg-muted pt-32 pb-12 sm:pb-16 lg:pb-24'>
      <div className='mx-auto flex h-full max-w-7xl flex-col gap-16 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex max-w-4xl flex-col items-center gap-4 self-center text-center'>
          ...
          <MotionPreset fade blur slide={{ direction: 'down', offset: 30 }} delay={0.15} transition={{ duration: 0.6 }}>
          ...
          <MotionPreset fade blur slide={{ direction: 'down', offset: 30 }} delay={0.3} transition={{ duration: 0.6 }}>
            <p className='text-muted-foreground mx-auto max-w-2xl text-xl'>
              Learn how to design, develop, launch, and grow digital products through practical knowledge and proven
              frameworks.
            </p>
          </MotionPreset>
          <MotionPreset fade blur slide={{ direction: 'down', offset: 30 }} delay={0.45} transition={{ duration: 0.6 }}>
